...
public class ResourceUtil {
    ...
    //Borders
    public static final ResourceLocation QUICKSILVER_FRAME = ResourceLocation.fromNamespaceAndPath(MoreMagichemLabels.MODID, "textures/gui/tooltip/frame/quicksilver_frame.png");
    public static final ResourceLocation GOLD_FRAME = ResourceLocation.fromNamespaceAndPath(MoreMagichemLabels.MODID, "textures/gui/tooltip/frame/gold_frame.png");
    public static final ResourceLocation ELECTRUM_FRAME = ResourceLocation.fromNamespaceAndPath(MoreMagichemLabels.MODID, "textures/gui/tooltip/frame/electrum_frame.png");
    public static final ResourceLocation CHIMERITE_FRAME = ResourceLocation.fromNamespaceAndPath(MoreMagichemLabels.MODID, "textures/gui/tooltip/frame/chimerite_frame.png");
    ...
    public static ResourceLocation rloc(String path) {
        return ResourceLocation.fromNamespaceAndPath(MoreMagichemLabels.MODID, path);
    }
